...
const contractABI = require("../artifacts/contracts/Langchainembed.sol/Langchainembed.json").abi;

program
    .name("langchainembed-cli")
    .description("CLI tool for Langchainembed smart contract")
    .version("1.0.0");
